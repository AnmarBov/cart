...
class Control:
    ...
    # Function to move right
    def smooth_right(self, value):
        self.value = value
        self.rpwm.start(0)
        self.rpwm.ChangeDutyCycle(self.value / 4)
        self.rpwm_2.start(0)
        self.rpwm_2.ChangeDutyCycle(self.value)

    # Function to move left
    def left(self, value):
        print('value from left', str(value))
        self.value = value
        self.rpwm.start(0)
        self.rpwm.ChangeDutyCycle(self.value)
        self.lpwm_2.start(0)
...
# Function to move left
    def smooth_left(self, value):
        print('value from left', str(value))
        self.value = value
        self.rpwm.start(0)
        self.rpwm.ChangeDutyCycle(self.value)
        self.rpwm_2.start(0)
        self.rpwm_2.ChangeDutyCycle(self.value / 4)
